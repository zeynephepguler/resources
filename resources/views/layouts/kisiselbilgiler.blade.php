      ...
      <div class="container">
           <div class="row">
              <div class="col-md-6 col-md-offset-3">
                     ...
                     <center><img src="uploads/ogrenci/{{ $LoggedUserInfo['image'] }}" width=200px>  
                     <table class="table table-hover">
                       ...
                       <tr><td class="tab">Doğum Tarihi:</td> <td class="tab2">{{ $LoggedUserInfo['no'] }}</td> </tr>
                       ...
                       <tr><td class="tab">Fakülte:</td> <td class="tab2">{{ $LoggedUserInfo['fakulte'] }} </td> </tr>
                       <tr><td class="tab">Bölüm:</td> <td class="tab2">{{ $LoggedUserInfo['bolum'] }} </td> </tr>
                       <tr><td class="tab">Sınıf:</td> <td class="tab2">{{ $LoggedUserInfo['sınıfsec'] }} </td> </tr>
